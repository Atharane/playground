...
export default function App() {
	return (
		<main className="h-screen flex size-full flex-col items-center justify-center overflow-y-auto p-4 md:p-8">
...
const Button = () => {
	...
	return (
		<motion.button
			...
			layout="position"
			className="flex h-14 cursor-default items-center gap-2.5 overflow-hidden rounded-full px-6 text-xl font-semibold tracking-[-0.4px]"
		>
...
const LoaderIcon = (props: { className: string }) => (
	<svg
		viewBox="0 0 24 24"
...
const SolidWarningIcon = (props: { className: string }) => (
	<motion.svg
		viewBox="0 0 26 26"
		fill="none"
		xmlns="http://www.w3.org/2000/svg"
...
const SolidCheckIcon = (props: { className: string }) => (
	<svg
		viewBox="0 0 26 26"
		fill="none"
		xmlns="http://www.w3.org/2000/svg"
